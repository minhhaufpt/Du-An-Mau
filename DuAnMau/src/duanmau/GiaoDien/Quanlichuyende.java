 ...
 */
public class Quanlichuyende extends javax.swing.JFrame {

    /**
     * Creates new form Quanlichuyende
     */
    public Quanlichuyende() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Quanlichuyende.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Quanlichuyende().setVisible(true);
            }
        });
    }
